package com.example.appmeeting.firebase;
...
import com.example.appmeeting.activities.IncomingInvitationActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null){
            Log.d("FCM", "RemoteMessage message: " + remoteMessage.getNotification().getBody());
        }
