...
import com.example.appmeeting.network.ApiClient;
import com.example.appmeeting.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // đoạn code lấy token cũng là dựa theo chatgpt vì thư viện FirebaseInstanceId cũ quá
...
//        });
        ...
        imageStopInvitation.setOnClickListener(v -> {
            if (getIntent().getBooleanExtra("isMultiple", false)){
                ...
                ArrayList<User> receivers = new Gson()
        ...
        // doạn code sau khi thay đổi thư viện gióngo của video
            ...
            public void onResponse(@NotNull Call<String> call, @NotNull Response<String> response) {
                if(response.isSuccessful()){
                    if(type.equals(Constants.REMOTE_MSG_INVITATION)){
                        ...
                        Toast.makeText(OutgoingInvitationActivity.this,
                                "Invitation Cancelled", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
                else{
